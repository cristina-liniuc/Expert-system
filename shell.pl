...
iknow :- 
	abolish(known/3), 
	dynamic(known/3),
	write('About whom you want to know more?'), nl,
	write('[marvin, collin, supercomputer, luna_President, luna_city_major'), nl,
	write('mice, artur_dent, ford_prefect, trillian, zafod, elvis_presley, agrajag]'), nl,
